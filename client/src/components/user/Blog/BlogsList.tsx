          ...
          <div>
            {categories &&
              categories.map((category: ICategory) => (
                <button
                  key={category._id}
                  className="mx-1 border-blue-500  bg-blue-600 text-white outline-none text-lg rounded-lg px-6 py-3 my-5"
                >
                  {category.name}
                </button>
              ))}
          ...
          <div>
            {tags &&
              tags.map((tag: ITag) => (
                <button
                  key={tag._id}
                  className="mx-1 border-blue-500  hover:bg-blue-600 hover:text-white outline-none text-blue-500 text-lg rounded-lg px-6 py-3 my-5"
                >
                  {tag.name}
                </button>
              ))}
